...
class Sentiments(TestCase):
    ...
    #     self.append_code("helpers.py", File("resources/finance/lookup.py"))
    #
    ...
    def smile_love(self):
        ...
        out = self.spawn("python3 smile love").stdout()
    ...
    def smile_hate(self):
        ...
        self.include("positive-words.txt")
        self.include("negative-words.txt")
        out = self.spawn("python3 smile hate").stdout()
        stripped = Sentiments.ansi_escape.sub('', out).rstrip()
        if (stripped != ":("):
    ...
    def smile_jellyfish(self):
        ...
        self.include("positive-words.txt")
        self.include("negative-words.txt")
        out = self.spawn("python3 smile jellyfish").stdout()
        stripped = Sentiments.ansi_escape.sub('', out).rstrip()
        if (stripped != ":|"):
    ...
    def smile_no_args(self):
        ...
        self.include("positive-words.txt")
        self.include("negative-words.txt")
        self.spawn("python3 smile").exit(1)
    ...
    def smile_too_many_args(self):
        ...
        self.include("positive-words.txt")
        self.include("negative-words.txt")
        self.spawn("python3 smile love hate").exit(1)
