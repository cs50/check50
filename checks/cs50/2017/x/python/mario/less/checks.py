...
class MarioLessPython(TestCase):
    ...
    def test1(self):
        ...
        self.include("cs50.py")
        out = self.spawn("python3 mario.py").stdin("1").stdout().split("\n")
    ...
    def test2(self):
        ...
        self.include("cs50.py")
        out = self.spawn("python3 mario.py").stdin("2").stdout().split("\n")
    ...
    def test23(self):
        ...
        self.include("cs50.py")
        out = self.spawn("python3 mario.py").stdin("23").stdout().split("\n")
